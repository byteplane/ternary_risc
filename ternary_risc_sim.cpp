    ...
    switch(imm) {
        case 1: // HALT
            ...
            *cpu_retval = a;
            ...
            break;
        case 2: // INPUT
            printf("Called syscallr(2): INPUT\n");
            break;
        case 3: // ICOUNT
            printf("Called syscallr(3): ICOUNT\n");
            break;
        case 4: // OUTPUT
            printf("Called syscallr(4): OUTPUT\n");
            putchar(bin_to_ternchar(a));
            break;
        case 5: // OCOUNT
            printf("Called syscallr(5): OCOUNT\n");
            break;
        case 6: // DUMP
            printf("Called syscallr(6): DUMP\n");
            SHOW_CPU_STATUS;
            break;
        default:
            break;
